...
<p align="justify">Con la aplicación de todo esto, se ha obtenido una reconstrucción bastante completa de la escena (11.679 puntos dibujados) en un tiempo bastante rápido (53 segundos).
Las franjas de puntos vacías que se aprecian en el segundo vídeo, es debido a que la plataforma se desconectaba y se volvía a conectar, y durante el tiempo de desconexión no pintaba dichos puntos. Respecto a la diferencia de tiempos entre los vídeos pensamos que también es debido al estado, en ese momento, de la plataforma.</p>
